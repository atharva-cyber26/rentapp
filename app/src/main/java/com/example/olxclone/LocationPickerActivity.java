...
import com.example.olxclone.databinding.ActivityLocationPickerBinding;
...
public class LocationPickerActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private @NonNull ActivityLocationPickerBinding binding;
    ...
    private  void addressFromLatLng(LatLng latLng){
        ...
        try {
            ...
            String locoality  =address.getLocality();
